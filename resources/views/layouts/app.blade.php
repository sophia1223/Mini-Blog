...
<html>
	<head>
		...
		<style type="text/css">
			...
			.header{padding: 10px 50px;border-bottom: 1px solid #eeeeee;}
			...
			.footer{padding: 10px 50px;background-color: gray;}
	...
	<div class="header">
		...
		<div class="menu"><a href="{{ route('articles.index') }}">Articles</a></div>
	</div>
	</body>
	<div class="content">
		<div class="left">
		...
		<div class="right">
			<div style="padding:20px;border:1px solid black;">
				...
				<p>name : Sophia</p>
				<p>age : 23</p>
				<p>Tel : 130-6009-1223</p>
			</div>
		</div>
	</div>
	<div class="footer">
		<p>contact me : QQ741654673</p>
	</div>
</html>